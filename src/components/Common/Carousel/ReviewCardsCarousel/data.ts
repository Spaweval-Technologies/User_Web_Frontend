...
const reviewDetails: ReviewCardProps[] = [
  {
    ...
    reviews: 42,
    description:
      'Great experience, easy to book. Paying for treatments is so convenient — no cash or cards needed! Such a sleek and powerful app.',
  },
  {
    img: Icons.ProfileImg,
    alt: 'anton',
    ...
    reviews: 42,
    description:
      "Recently moved to a new city and didn't know any salons. Fresha gave me a whole new list to choose fromThe consultation forms and free SMS reminders are so convenient.",
  },
  {
    img: Icons.ProfileImg,
    alt: 'susan',
